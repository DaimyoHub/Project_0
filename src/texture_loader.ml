...
let prepare_texture_handler texture_handler images =
  List.iter (fun (i, n) ->
    let texture_kind = 
      ...
      else if n = "player_1_right_melee_0"   then Player_1_right_melee_0
      else if n = "player_1_right_melee_1"   then Player_1_right_melee_1
      else if n = "player_2_right_melee_0"   then Player_2_right_melee_0
      else if n = "player_2_right_melee_1"   then Player_2_right_melee_1
      else if n = "player_1_left_melee_0"    then Player_1_left_melee_0
      else if n = "player_1_left_melee_1"    then Player_1_left_melee_1
      else if n = "player_2_left_melee_0"    then Player_2_left_melee_0
      else if n = "player_2_left_melee_1"    then Player_2_left_melee_1
      else if n = "player_1_bottom_melee_0"  then Player_1_bottom_melee_0
      else if n = "player_1_bottom_melee_1"  then Player_1_bottom_melee_1
      else if n = "player_2_bottom_melee_0"  then Player_2_bottom_melee_0
      else if n = "player_2_bottom_melee_1"  then Player_2_bottom_melee_1
      else if n = "player_1_top_melee_0"     then Player_1_top_melee_0
      else if n = "player_1_top_melee_1"     then Player_1_top_melee_1
      else if n = "player_2_top_melee_0"     then Player_2_top_melee_0
      else if n = "player_2_top_melee_1"     then Player_2_top_melee_1
